					...
					<div class="col-md-10 offset-md-1">
						       ...
						       @if($galleryslide )
                                ...
                                <h1 class="text-center ga_title">{{ $galleryslide->$tit}}</h1>
                                
                             
                                <img src="{{ asset('numerus') }}/images/{{ $galleryslide->img}}"   title="{{ $galleryslide->$tit}}" alt="{{ $galleryslide->$keywords}}" class="img-fluid ga_mainimg" >
                               
                          
                                <p class="ga_info text-center">
                                        <a class="display-4" href="{{  route('gallery', app()->getLocale()) }}" target="_blank" title="{{ trans('lang.gallery')}}">{{ trans('lang.gallery')}}</a> <br><br>
                                    
                                    <i class="icon-calendar3"></i> {{ $galleryslide->created_at->format('F d , Y' ) }}   </p>
                    
                          
                              <p class="text-center">
                              
                                   <div class="fb-share-button " id="fb-share-button" style="margin-left:47%; margin-bottom:20px;" data-href="http://youandworld.am/{{app()->getLocale()}}/gallery/{{ $galleryslide->$al }}" data-layout="button_count" data-size="large"> <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fyouandworld.am%2F{{app()->getLocale()}}%2Fgallery%2F{{ $galleryslide->$al }}&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore" title="{{ $galleryslide->$al }}">Share</a></div>
