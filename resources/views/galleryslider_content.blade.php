...
<h1  class="text-center">{{ trans('lang.gallery')}}</h1>
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    @set($i, 1)
            @foreach($galleryslider as $k=>$galleryslide)
            @if($k==0)
              <div class="carousel-item active ">
                <a href="{{ route('gallery.show', ['alias'=>$galleryslide->$al,'locale'=>app()->getLocale()]) }}" title="{{ $galleryslide->$desc }}"> 
                <img src="{{ asset('numerus') }}/images/{{ $galleryslide->img }}" alt="{{ $galleryslide->$desc }}" class="mx-auto w-100 img-fluid" >
               
                    <h4 class="  text-center bg-secondary text-white p-2 ">{{ $galleryslide->$tit }}</h4>
  ...
  <a class="carousel-control-next " href="#demo" data-slide="next">
    <span class="carousel-control-next-icon bg-dark"></span>
       ...
       <p class="text-center">
                                   ...
                                   <div class="fb-share-button " id="fb-share-button" style="margin-left:47%; margin-bottom:20px;" data-href="http://youandworld.am/{{app()->getLocale()}}/gallery" data-layout="button_count" data-size="large"> <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fyouandworld.am%2F{{app()->getLocale()}}%2Fgallery%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore" title="{{ trans('lang.gallery') }}">Share</a></div>
